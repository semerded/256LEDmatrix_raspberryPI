...
class LoadingScreen:
    def __init__(self, APP: AppConstructor, text: str) -> None:
        ...
        self.loadingWidget.text(text, Font.customFont(int(ScreenUnit.vw(4))), Color.GREEN, overFlow.show)
  
    def place(self):
            if self.APP.everyAmountOfTicks(20):
                self.loadingWidget.text(self._loadingText(), Font.customFont(int(ScreenUnit.vw(4))), Color.GREEN, overFlow.show)
